public class Tree {
    ...
    public int minValue() { //Минимальное значение
    ...
    public int maxValue() { //максимальное значение
    ...
    public int depth() { //возвращает глубину дерева;
        return depth(Root);
    }
    ...
    public int sum() { //сумма всех элементов дерева
        return sum(Root);
    }
    ...
    public int count() {  //возвращает количество элементов дерева;
        return count(Root);
    }
    ...
    public double avg() { //возвращает среднее-арифметическое элементов дерева
        int sum = sum();
        int count = count();
        return (double) sum / count;
    }

    public void clear() { //очищает дерево (удаляет все его элементы);
        Root = null;
    }
